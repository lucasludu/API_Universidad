    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Estudiantes_Careers_CareerId",
                        column: x => x.CareerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfesorSubjects", x => new { x.ProfesorId, x.SubjectId });
                    table.ForeignKey(
                        name: "FK_ProfesorSubjects_Profesores_ProfesorId",
                        column: x => x.ProfesorId,
                        principalTable: "Profesores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfesorSubjects_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EstudianteSubjects", x => new { x.EstudianteId, x.SubjectId });
                    table.ForeignKey(
                        name: "FK_EstudianteSubjects_Estudiantes_EstudianteId",
                        column: x => x.EstudianteId,
                        principalTable: "Estudiantes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EstudianteSubjects_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Estudiantes_CareerId",
                table: "Estudiantes",
                column: "CareerId");

            migrationBuilder.CreateIndex(
                name: "IX_EstudianteSubjects_SubjectId",
                table: "EstudianteSubjects",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfesorSubjects_SubjectId",
                table: "ProfesorSubjects",
                column: "SubjectId");
        }
